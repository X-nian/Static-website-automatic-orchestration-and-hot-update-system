...
body='''<main id="main" class="skills-page"><a class="back-link" href="/news/">← AIGC 创作笔记</a><div class="eyebrow"><span>REUSABLE CREATIVE WORKFLOWS</span><span>02 SKILLS</span></div><header class="skills-header"><p class="section-code">给 AI 助手使用的工作指南</p><h1>创作 Skill 库</h1><p class="article-summary">把反复使用的方法整理成可以下载、检查和继续修改的完整文件夹。</p></header><div class="skill-grid"><article class="skill-tile"><span>01 / VIDEO & IMAGE</span><h2>AIGC 镜头工坊</h2><p>拆解镜头、编写提示词、生成关键帧示意图，并按用途检查人物与场景素材。</p><ul><li>镜头规划</li><li>提示词</li><li>素材验收</li></ul><a href="/news/skills/aigc-shot-workshop/">查看说明与下载 ↗</a></article><article class="skill-tile"><span>02 / CONTENT</span><h2>多平台内容工作室</h2><p>学习指定账号的历史风格，把一份素材整理为小红书、公众号、B站等平台的差异化草稿。</p><ul><li>风格学习</li><li>多平台改稿</li><li>版本追踪</li></ul><a href="/news/skills/multi-platform-content/">查看说明与下载 ↗</a></article></div></main>'''
