...
<link rel="stylesheet" href="/news/news.css?v=2"><link rel="stylesheet" href="/news/reading.css?v=1">
<script src="/news/orbit.js?v=1" defer></script></head><body class="{kind}">
<a class="skip-link" href="#main">跳到正文</a><header class="masthead"><a class="brand" href="/">TOY<span>®</span></a>
<nav aria-label="主导航"><a href="/">作品集</a><a href="/news/">AIGC 观察</a><a href="/news/skills/aigc-shot-workshop/">镜头工坊</a></nav><span class="edition-label">DESIGN × TECHNOLOGY</span></header>
{body}<footer class="reading-footer"><a href="/">TOY / 创作持续发生</a><a href="#main">回到顶部 ↑</a></footer></body></html>'''
...
def sidebar(current):
    ...
    return f'''<aside class="reader-sidebar"><details open class="navigation-panel"><summary>文章导航 <span>展开 / 收起</span></summary><div class="navigation-content">
<div class="orbit-block"><div class="orbit" aria-label="球形文章导航"><div class="orbit-ring" aria-hidden="true"></div>{nodes}</div><p class="orbit-hint">拖动或在球内滚动，点击标题阅读。</p><div class="orbit-controls"><button type="button" data-turn="-1" aria-label="向左旋转文章球">←</button><button type="button" data-turn="1" aria-label="向右旋转文章球">→</button></div></div>
<nav aria-label="全部文章"><p class="section-code">全部文章 · {len(ARTICLES)} 篇</p><ol class="article-list">{links}</ol></nav><a class="sidebar-skill" href="/news/skills/aigc-shot-workshop/">AIGC 镜头工坊 · Skill ↗</a></div></details></aside>'''
...
featured=ARTICLES[5]
feature=f'''<a class="feature-story" href="{url(featured)}"><p class="section-code">进阶实践 / 镜头设计</p><h3>{e(featured['title'])}</h3><p>{e(featured['summary'])}</p><span>阅读全文 ↗</span></a>'''
cards=''.join(f'<article class="story-row"><span class="row-number">{i+1:02}</span><div><p class="section-code">{e(a["section"])}</p><h3>{link(a)}</h3><p>{e(a["summary"])}</p></div></article>' for i,a in enumerate(ARTICLES) if a!=featured)
archive=''.join(f'<li><span>{e(a["section"])}</span>{link(a)}<time datetime="{a["updated"]}">{a["updated"]}</time></li>' for a in ARTICLES)
body=f'''<main id="main"><div class="eyebrow"><span>THE CREATIVE FIELD NOTES</span><span>TOY / 独立观察</span></div><section class="intro"><div><p class="section-code">创作现场 · 观察与记录</p><h1>AIGC <em>观察<span class="title-dot">.</span></em></h1></div><p class="intro-note">从设计师的视角，<br>看技术如何改变表达。</p></section><div class="issue-bar"><span>7 篇文章 · 1 个 Skill</span><span>新手教程 / 值得关注 / 进阶实践</span><a href="#archive">全部文章 ↘</a></div><div class="editorial-grid"><div class="main-column"><section><div class="section-heading"><h2>值得关注 <span>IN FOCUS</span></h2><span class="section-index">01</span></div>{feature}</section><section class="brief-section"><div class="section-heading"><h2>继续探索 <span>MORE TO READ</span></h2><span class="section-index">02</span></div>{cards}</section></div><aside class="side-column"><section class="editor-note"><div class="note-top"><span>编 辑 手 记</span></div><p class="note-english">A NOTE<br>FROM TOY</p><h2 class="note-story-title">为《媚人》搭建一座黑色宴会厅</h2><p>从黑红配色到空间检查，记录一次把歌曲感受变成画面的尝试。</p><a href="{url(ARTICLES[0])}">阅读制作记录 ↗</a><div class="note-signature"><span>个人视角 / 创作实践</span><strong>TOY</strong></div></section><section class="about-column"><h2>从方法到实践</h2><p>镜头规划和素材验收，配有可下载的 AI 助手工作指南。</p><a href="/news/skills/aigc-shot-workshop/">了解 AIGC 镜头工坊 ↗</a></section></aside></div><section id="archive" class="archive"><div class="section-heading"><h2>全部文章 <span>THE ARCHIVE</span></h2><span class="section-index">03</span></div><p class="archive-caption">按阅读顺序排列 · 日期为内容更新日期</p><ol class="archive-list">{archive}</ol></section></main>'''
